...
async function* myReadable(ac: AbortController) {
...
async function* myWritable(source: AsyncIterable<Buffer>) {
...
await pipeline(
  myReadable(abortController), // ✅ call it with AbortController
